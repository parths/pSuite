...
public class ImageListArrayAdapter extends ArrayAdapter<ImageListItem>
{
	...
	public ImageListArrayAdapter(Context context, int textViewResourceId, List<ImageListItem> listItems)
	{
	...
	public ImageListItem getItem(int idx)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		ImageListItem item = listItems.get(position);
		if(item != null)
		{
